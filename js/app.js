...
import {initClickHandler} from "./clickHandler"; // Le clickHandler mis à jour
...
import {initIntroAnimation} from "./intro";
...
// Initialisation du traitement des clics avec передачей renderer
const clickHandler = initClickHandler(celestialObjects, camera, scene, controls, renderer);
